...
#include "../../CryEngine/CryCommon/IConsole.h"  // SDK types: ICVar, IOutputPrintSink, etc.
...
struct IConsole {
    ...
    virtual ICVar* RegisterString(const char* name, const char* value, int flags, const char* help = "", void* onChange = nullptr) = 0; // [2]  0x10  CXConsoleVariableString
    virtual ICVar* RegisterInt(const char* name, int value, int flags, const char* help = "", void* onChange = nullptr) = 0;           // [3]  0x18  CXConsoleVariableInt
    virtual void _vf4() = 0;                                                                           // [4]  0x20
    virtual void _vf5() = 0;                                                                           // [5]  0x28
    virtual void _vf6() = 0;                                                                           // [6]  0x30
    virtual ICVar* RegisterCVarStr(const char* name, const char** src, const char* def, int flags = 0, const char* help = "", void* onChange = nullptr, bool allowModify = true) = 0; // [7]  0x38
    virtual ICVar* RegisterCVarInt(const char* name, int* src, int def, int flags = 0, const char* help = "", void* onChange = nullptr, bool allowModify = true) = 0;                // [8]  0x40
    ...
    virtual void AddCommandScript(const char* name, const char* scriptFunc, int flags = 0, const char* help = "") = 0; // [32] 0x100
    virtual void AddCommand(const char* name, void (*func)(IConsoleCmdArgs*), int flags = 0, const char* help = "") = 0; // [33] 0x108
