...
// Size: 0x78
//
// Entity binding — the primary per-entity RPG interface. Largest rpgmodule
// scriptbind with 48+ methods covering stats, skills, perks, buffs, combat,
// reputation, roles, and appearance.
