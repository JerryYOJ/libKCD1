...
// Registration: 0x1800b3ba0
#pragma pack(push, 1)
struct S_OppActorClassTableRow_2 {
    ...
    int32_t opp_attack_type_id;  // 0x09C
    ...
    int32_t blocking_hand;  // 0x0C0
    int32_t guard_type_id;  // 0x0C4
    int32_t guard_stance_id;  // 0x0C8
    int32_t opp_guard_stance_id;  // 0x0CC
    int32_t guard_zone_id;  // 0x0D0
    int32_t action_type_id;  // 0x0D4
    int32_t end_guard_type_id;  // 0x0D8
    int32_t end_guard_zone_id;  // 0x0DC
    int32_t end_guard_stance_id;  // 0x0E0
    float min_distance;  // 0x0E4
    float max_distance;  // 0x0E8
...
#pragma pack(pop)
static_assert(sizeof(S_OppActorClassTableRow_2) == 264, "Size mismatch for S_OppActorClassTableRow_2");
