...
// Registration: 0x1800cb290
#pragma pack(push, 1)
struct S_OppActorClassTableRow_8 {
    ...
    int32_t attack_zone_id;  // 0x098
    int32_t attack_type_id;  // 0x09C
    int32_t input_class_id;  // 0x0A0
    int32_t side_id;  // 0x0A4
    int32_t r_weapon_class_id;  // 0x0A8
    int32_t l_weapon_class_id;  // 0x0AC
    int32_t r_weapon_group_id;  // 0x0B0
    int32_t l_weapon_group_id;  // 0x0B4
    int32_t opp_r_weapon_class_id;  // 0x0B8
    int32_t opp_l_weapon_class_id;  // 0x0BC
    int32_t opp_r_weapon_group_id;  // 0x0C0
    int32_t opp_l_weapon_group_id;  // 0x0C4
    int32_t blocking_hand;  // 0x0C8
    bool virtual_dagger;  // 0x0CC
    uint8_t _pad_0x0CD[3];
...
#pragma pack(pop)
static_assert(sizeof(S_OppActorClassTableRow_8) == 264, "Size mismatch for S_OppActorClassTableRow_8");
