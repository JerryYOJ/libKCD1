...
// Table: "actor_action_type"  row_size: 80
// Registration: 0x1800ec1b0
#pragma pack(push, 1)
struct S_ActorActionTypeTableRow_2 {
...
#pragma pack(pop)
static_assert(sizeof(S_ActorActionTypeTableRow_2) == 80, "Size mismatch for S_ActorActionTypeTableRow_2");
