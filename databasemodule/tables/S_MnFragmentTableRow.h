...
// Registration: 0x1800b8070
#pragma pack(push, 1)
struct S_MnFragmentTableRow {
    ...
    int32_t attack_zone_id;  // 0x0A0
    int32_t block_zone_id;  // 0x0A4
...
#pragma pack(pop)
static_assert(sizeof(S_MnFragmentTableRow) == 256, "Size mismatch for S_MnFragmentTableRow");
