...
// -----------------------------------------------
// RTTI: .?AVC_ScriptBindDatabase@databasemodule@wh@@
// vtable: 0x1822c1fb8
// Constructed inline within sub_180F37930 (C_DatabaseModule init)
// Registration: sub_180F3A708
// Size: 0x68
...
public:
    void* m_pDatabaseManager;  // +0x60  pointer to table container (DatabaseModule+0x88)
