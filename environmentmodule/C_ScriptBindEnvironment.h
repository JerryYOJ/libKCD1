...
// -----------------------------------------------
// RTTI: .?AVC_ScriptBindEnvironment@environmentmodule@wh@@
// vtable: 0x1822e54a8
// Constructor: sub_1810FCAC4
// Registration: sub_1810FE508
// Size: 0x70
...
public:
    ...
    int ForceImmediateWeatherUpdate(IFunctionHandler* pH);                                  // 0x180F32EF0 (stub)
};
