...
// Size: 0x88
//
// Entity binding — stored at C_EntityModule+0xB0.
...
public:
    ...
    void*                   m_pModule;          // +0x70
    Offsets::IScriptTable*  m_pEntityTable1;    // +0x78  via sub_18044478C
    Offsets::IScriptTable*  m_pEntityTable2;    // +0x80  via sub_18044478C
    ...
    int SetMountedAngleLimits(IFunctionHandler* pH, float min_pitch, float max_pitch, float yaw_range); // 0x180F32EF0
    ...
    int BelongsToDeadBody(IFunctionHandler* pH);                                    // 0x1810BF514
    ...
    int GetHealth(IFunctionHandler* pH);                                            // 0x180F32EF0
    int GetMaxHealth(IFunctionHandler* pH);                                         // 0x180F32EF0
