...
// -----------------------------------------------
// C_UIInventoryElements 鈥?inventory popup dialogs ("UIInventoryController")
// -----------------------------------------------
...
//                  vtable 0x1822e8948; allocates 0x60, returns this+8 鈥?the
...
//       [0] "ShowInfoDialog" 鈥?"Show info dialog"
...
public:
    ...
    Offsets::IUIEventSystem*  m_pUIEvents;           // +0x50  system->UI "InventoryElements" (NOT initialized by the ctor 鈥?only by InitEventSystem; factory does not memset)
