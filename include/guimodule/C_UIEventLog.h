...
// -----------------------------------------------
// C_UIEventLog — game-event log -> Flash bridge ("GameEventLog")
// -----------------------------------------------
// RTTI: .?AVC_UIEventLog@@   *** GLOBAL namespace — declared at global
...
//                  vtable 0x1822e76d0; allocates 0x30, returns this+8 — the
...
//           1 slot — this vtable is the proof the interface has no virtual
//           dtor and one method)
...
//        [0] "OnGameEvent" — "triggered when GameEvent is fired"
