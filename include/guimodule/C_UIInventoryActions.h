...
// -----------------------------------------------
// C_UIInventoryActions — inventory/shop flash <-> game bridge
// -----------------------------------------------
// RTTI: .?AVC_UIInventoryActions@guimodule@wh@@  (3 vtables: +0x00/+0x08/+0x10)
//   0x1822e8978 IUIModule (9 slots: 8 IUIModule + own [8], see below) —
//               overrides: [0] dtor sub_181129BC8, [1] Init sub_18112D64C
//   0x1822e89c8 I_InventoryListener        (4 slots)
//   0x1822e89f0 I_EquipmentManagerListener (3 slots)
// Constructor: sub_181126124 — called by CUIManager ctor sub_181125C08
//              (allocation 0x70)
// Size:        0x70
//
...
//
// IUIModule::Init (sub_18112D64C) — run once game systems exist:
...
//   notification sources feeding OnItemAdded/OnItemRemoved — exact system
//   identity UNVERIFIED).
