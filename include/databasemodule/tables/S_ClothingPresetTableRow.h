...
// Table: "clothing_preset"  row_size: 104
// Registration: 0x1800f50d0
#pragma pack(push, 1)
struct S_ClothingPresetTableRow {
    uint8_t _rowbase[16];  // 0x000
    uint64_t clothing_preset_id;  // 0x010  // PK
    // uint64_t attachment_base_id;  // 0x010 (alias)  // PK
...
#pragma pack(pop)
static_assert(sizeof(S_ClothingPresetTableRow) == 104, "Size mismatch for S_ClothingPresetTableRow");
