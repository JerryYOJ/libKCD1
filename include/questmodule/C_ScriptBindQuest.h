...
// RTTI: .?AVC_ScriptBindQuest@questmodule@wh@@  vtable: 0x182314ef8
// Constructor: sub_18129BC38  Registration: sub_1812A0678  Size: 0x70
...
public:
    ...
    // int UserEnteredTrigger(IFunctionHandler* pH);                       // 0x1812A2A90
    ...
    // int CancelQuest(IFunctionHandler* pH);                              // 0x18129CB68
    ...
    // int RegisterQuestEntity(IFunctionHandler* pH);                      // 0x180F32EF0 (noop)
