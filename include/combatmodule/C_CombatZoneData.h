...
struct C_CombatZoneData {
    ...
    int32_t     _pad04;                     // +0x04
    const char* combat_zone_name;           // +0x08  CryStringT<char>
    const char* attack_mn_tag;              // +0x10  CryStringT<char>
    uint8_t     _runtime18[0x10];           // +0x18  zero-init runtime
    const char* defense_mn_tag;             // +0x28  CryStringT<char>
    uint8_t     _runtime30[0x10];           // +0x30
    const char* start_mn_tag;               // +0x40  CryStringT<char>
    uint8_t     _runtime48[0x10];           // +0x48
    const char* end_mn_tag;                 // +0x58  CryStringT<char>
    uint8_t     _runtime60[0x10];           // +0x60
    const char* riposte_mn_tag;             // +0x70  CryStringT<char>
